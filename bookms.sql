...
LOCK TABLES `book` WRITE;
/*!40000 ALTER TABLE `book` DISABLE KEYS */;
INSERT INTO `book` VALUES (1,'C++从入门到入坟','捏','🐔算机','电子工业出版社',9,'我大C++天下无敌啊！','1231231123123','1112-02-03'),(2,'JAVA从精通到忘记','丛先生','🐔算机','电子工业出版社',21,'就不是给人学的','2423497234273','1428-11-05'),(5,'能力额','捏','数学','捏出版社',1145,'123123123','8976712418927','1999-01-09'),(10,'23123','123213','1231234','455',5,'10rifjf','1231452365465','2025-04-11'),(11,'测试','测试','🐔算计','103出版社',33,'222222','4235678345678','2025-05-22');
/*!40000 ALTER TABLE `book` ENABLE KEYS */;
UNLOCK TABLES;
...
LOCK TABLES `ticket` WRITE;
/*!40000 ALTER TABLE `ticket` DISABLE KEYS */;
INSERT INTO `ticket` VALUES (1,'hello','高','test','hello world',2,1,'2025-04-29','2025-04-30',1),(2,'world','中','5yuhgf',NULL,2,1,'2025-04-29',NULL,1),(3,'bgfd','高','erfgbnbf','ok',2,1,'2025-04-29','2025-05-02',1),(4,'能力额','高','你是个傻逼','dasjld',2,1,'2025-04-30','2025-05-03',1),(9,'我想添加几本书','高','《我的前半生》\r\n《量子力学》','不行',2,1,'2025-04-30','2025-04-30',1),(10,'测试工单','高','测试测试',NULL,6,0,'2025-05-02',NULL,0),(11,'测试工单','低','你好你好你好你好',NULL,2,0,'2025-05-03',NULL,0);
/*!40000 ALTER TABLE `ticket` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2025-05-04 22:55:09
